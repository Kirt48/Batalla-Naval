...
function Player(nombre, tipoPlayer) {
  ...
  for (let i = 0; i < this.numBarcos; i++) {
    this.enbarcaciones[i] = new Barco(
      this.detallesBarcos[i].nombre,
      this.detallesBarcos[i].tamano
    );
  }
...
function anadirBarco(player, inicio, longitud, horientacion) {
  ...
  if (comprobarPuedePonerseLimiteCasillas(inicio, longitud, horientacion)) {
    if (
      comprobarPuedePonerseOtrosBarcos(inicio, longitud, horientacion, player)
    ) {
      var aux = inicio;
      for (let i = 1; i <= 10; i++) {
        if (i == 1) {
        ...
        if (horientacion == 0 && i == fila) {
          if (
            (player.barcos.length == 0 ||
              player.barcos.length == 1 ||
              player.barcos.length == 2 ||
              player.barcos.length == 3 ||
              player.barcos.length == 4) &&
            inicio - 1 >= aux
          )
            pos[inicio - 1].classList.add("noPonerMasBarcos");
          if (
            (player.barcos.length == 0 ||
              player.barcos.length == 1 ||
              player.barcos.length == 2 ||
              player.barcos.length == 3 ||
              player.barcos.length == 4) &&
            inicio + longitud < aux + 10
          )
            pos[inicio + longitud].classList.add("noPonerMasBarcos");
          for (let j = 0; j < longitud; j++) {
            if (inicio > 10) {
              if (
                ...
                pos[inicio - 10].classList.add("noPonerMasBarcos");
            }
            if (inicio < 91) {
              if (
                player.barcos.length == 0 ||
            ...
            if (player.barcos.length == 0)
              pos[inicio].classList.add("barcoPosicionadoUno");
            if (player.barcos.length == 1)
              pos[inicio].classList.add("barcoPosicionadoDos");
            if (player.barcos.length == 2)
              pos[inicio].classList.add("barcoPosicionadoTres");
            if (player.barcos.length == 3)
              pos[inicio].classList.add("barcoPosicionadoCuatro");
            if (player.barcos.length == 4)
              pos[inicio].classList.add("barcoPosicionadoCinco");
            if (
              player.barcos.length == 0 ||
              player.barcos.length == 1 ||
              player.barcos.length == 2 ||
              ...
              pos[inicio].classList.add("noPonerMasBarcos");
            inicio++;
          }
          ...
          if (
            (player.barcos.length == 0 ||
              ...
              player.barcos.length == 3 ||
              player.barcos.length == 4) &&
            auxExtra + longitud * 10 == inicio &&
            auxExtra + longitud * 10 < 101
          )
            pos[auxExtra + longitud * 10].classList.add("noPonerMasBarcos");
        }
      }
      player.barcos[player.barcos.length] = { localizaciones: [[]] };
      for (let i = 0; i < longitud; i++) {
        if (horientacion == 0) {
          player.barcos[player.barcos.length - 1].localizaciones[i] = [
            fila,
            columna,
          ];
          columna++;
...
function comprobarPuedePonerseOtrosBarcos(
  inicio,
  longitud,
  horientacion,
  player
...
function anadirBarcosAleatorios(player) {
  while (player.barcos.length < 5) {
    ...
    if (player.barcos.length == 0) {
      anadirBarco(
        player,
        numeroAleatorioInicio,
        5,
        numeroAleatorioHorientacion
      );
        ...
        switch (h) {
          case 0:
            ...
            if (player.nombre == "Player" && booll) {
              Jugador.BarcosDanadosCoordenadas[0][
                Jugador.BarcosDanadosCoordenadas[0].length
              ] = [fila, columna];
            } else if (player.nombre == "Bot" && booll) {
              Maquina.BarcosDanadosCoordenadas[0][
                Maquina.BarcosDanadosCoordenadas[0].length
              ] = [fila, columna];
            }
            break;
          case 1:
            ...
            if (player.nombre == "Player" && booll) {
              Jugador.BarcosDanadosCoordenadas[1][
                Jugador.BarcosDanadosCoordenadas[1].length
              ] = [fila, columna];
            } else if (player.nombre == "Bot" && booll) {
              Maquina.BarcosDanadosCoordenadas[1][
                Maquina.BarcosDanadosCoordenadas[1].length
              ] = [fila, columna];
            }
            break;
          case 2:
            ...
            if (player.nombre == "Player" && booll) {
              Jugador.BarcosDanadosCoordenadas[2][
                Jugador.BarcosDanadosCoordenadas[2].length
              ] = [fila, columna];
            } else if (player.nombre == "Bot" && booll) {
              Maquina.BarcosDanadosCoordenadas[2][
                Maquina.BarcosDanadosCoordenadas[2].length
              ] = [fila, columna];
            }
            break;
          case 3:
            ...
            if (player.nombre == "Player" && booll) {
              Jugador.BarcosDanadosCoordenadas[3][
                Jugador.BarcosDanadosCoordenadas[3].length
              ] = [fila, columna];
            } else if (player.nombre == "Bot" && booll) {
              Maquina.BarcosDanadosCoordenadas[3][
                Maquina.BarcosDanadosCoordenadas[3].length
              ] = [fila, columna];
            }
            break;
          case 4:
            player.tamDosDanado++;
            if (player.nombre == "Player" && booll) {
              Jugador.BarcosDanadosCoordenadas[4][
                Jugador.BarcosDanadosCoordenadas[4].length
              ] = [fila, columna];
            } else if (player.nombre == "Bot" && booll) {
              Maquina.BarcosDanadosCoordenadas[4][
                Maquina.BarcosDanadosCoordenadas[4].length
              ] = [fila, columna];
            }
            break;
        }
...
function saludBarco(player) {
  if (
    nombre == "portaaviones" &&
    player.BarcosDanadosCoordenadas[0].length == 5
  ) {
    console.log("portaaviones Hundido");
  } else if (
    nombre == "submarino" &&
    player.BarcosDanadosCoordenadas[1].length == 4
  ) {
    console.log("submarino Hundido");
  }
  if (
    nombre == "destructor" &&
    player.BarcosDanadosCoordenadas[2].length == 3
  ) {
...
function comprobarSiSepuedeLaPosicion(fila, columna, player) {
  ...
  for (let h = 0; h < player.BarcosDanadosCoordenadas.length; h++) {
    for (let j = 0; j < player.BarcosDanadosCoordenadas[h].length; j++) {
      if (
        fila == player.BarcosDanadosCoordenadas[h][j][0] &&
        columna == player.BarcosDanadosCoordenadas[h][j][1]
      ) {
        return true;
      }
    }
  ...
  for (let i = 0; i < player.coordenadasAgua.length; i++) {
    if (
      fila == player.coordenadasAgua[i][0] &&
      columna == player.coordenadasAgua[i][1]
    ) {
      return true;
    }
  }
    ...
    for (let j = 0; j < player.barcos[h].localizaciones.length; j++) {
      if (cordenada == player.barcos[h].localizaciones[j]) {
        switch (h) {
          case 0:
            if (
              Maquina.tamCincoDanado == 5 &&
              Maquina.totalBarcos > 0 &&
              player.tipoPlayer == "m"
            ) {
              Maquina.totalBarcos--;
              Maquina.actual++;
              agregarInformacion(
                "Has hundido el " +
                  Maquina.enbarcaciones[0].nombre +
                  " con una longitud de " +
                  Maquina.enbarcaciones[0].tamano +
                  " \nLe quedan " +
                  Maquina.totalBarcos +
                  " Barcos",
                true
              ...
              Jugador.tamCincoDanado == 6 &&
              Jugador.totalBarcos > 0 &&
              player.tipoPlayer == "j"
            ) {
              Jugador.totalBarcos--;
              Jugador.actual++;
              agregarInformacion(
                "Te han hundido el " +
                  Jugador.enbarcaciones[0].nombre +
                  " con una longitud de " +
                  Jugador.enbarcaciones[0].tamano +
                  " \nTe quedan " +
                  Jugador.totalBarcos +
                  " Barcos",
                true
          ...
          case 1:
            if (
              ...
              agregarInformacion(
                "Has hundido el " +
                  Maquina.enbarcaciones[1].nombre +
                  " con una longitud de " +
                  Maquina.enbarcaciones[1].tamano +
                  " \nLe quedan " +
                  Maquina.totalBarcos +
                  " Barcos",
                true
              ...
              agregarInformacion(
                "Te han hundido el " +
                  Jugador.enbarcaciones[1].nombre +
                  " con una longitud de " +
                  Jugador.enbarcaciones[1].tamano +
                  " \nTe quedan " +
                  Jugador.totalBarcos +
                  " Barcos",
                true
          ...
          case 2:
            if (
              ...
              agregarInformacion(
                "Has hundido el " +
                  Maquina.enbarcaciones[2].nombre +
                  " con una longitud de " +
                  Maquina.enbarcaciones[2].tamano +
                  " \nLe quedan " +
                  Maquina.totalBarcos +
                  " Barcos",
                true
              ...
              agregarInformacion(
                "Te han hundido el " +
                  Jugador.enbarcaciones[2].nombre +
                  " con una longitud de " +
                  Jugador.enbarcaciones[2].tamano +
                  " \nTe quedan " +
                  Jugador.totalBarcos +
                  " Barcos",
                true
          ...
          case 3:
            if (
              ...
              agregarInformacion(
                "Has hundido el " +
                  Maquina.enbarcaciones[3].nombre +
                  " con una longitud de " +
                  Maquina.enbarcaciones[3].tamano +
                  " \nLe quedan " +
                  Maquina.totalBarcos +
                  " Barcos",
                true
              ...
              agregarInformacion(
                "Te han hundido el " +
                  Jugador.enbarcaciones[3].nombre +
                  " con una longitud de " +
                  Jugador.enbarcaciones[3].tamano +
                  " \nTe quedan " +
                  Jugador.totalBarcos +
                  " Barcos",
                true
          ...
          case 4:
            if (
              ...
              agregarInformacion(
                "Has hundido el " +
                  Maquina.enbarcaciones[4].nombre +
                  " con una longitud de " +
                  Maquina.enbarcaciones[4].tamano +
                  " \nLe quedan " +
                  Maquina.totalBarcos +
                  " Barcos",
                true
              ...
              agregarInformacion(
                "Te han hundido el " +
                  Jugador.enbarcaciones[4].nombre +
                  " con una longitud de " +
                  Jugador.enbarcaciones[4].tamano +
                  " \nTe quedan " +
                  Jugador.totalBarcos +
                  " Barcos",
                true
...
function atacar(posAtaque) {
  ...
  if (Jugador.numeroAtaque == Maquina.numeroAtaque) {
    if (
      posAtaque.className.indexOf("tocado") != -1 ||
      posAtaque.className.indexOf("agua") != -1
    ) {
      return;
    }
    ...
    do {
      ...
      if (Maquina.continuar == false) {
        ...
        do {
          ...
          Maquina.orden.indexOf(ataqueAleatorio) != -1 ||
          ataqueAleatorio < 1 ||
          ataqueAleatorio > 4
        );
      ...
      if (
        Maquina.ultimaposicionColumna == 10 &&
        Maquina.ultimaposicionFila == 9
      ) {
        posAtaque = document.getElementById("j100");
      } else if (Maquina.ultimaposicionColumna == 10) {
        posAtaque = document.getElementById(
          "j" + (Maquina.ultimaposicionFila + 1) + "0"
        );
      } else {
        posAtaque = document.getElementById(
          "j" + Maquina.ultimaposicionFila + Maquina.ultimaposicionColumna
        );
      }

      if (posAtaque != null) {
        inicio = parseInt(
          posAtaque.id.substring(posAtaque.id.length - 1, posAtaque.id.length)
        );
        inicioCompleto = parseInt(
          posAtaque.id.substring(1, posAtaque.id.length)
        );
      }
      ...
      switch (Maquina.orden[Maquina.orden.length - 1]) {
        case 1:
          if (Maquina.ultimaposicionColumna == 9) {
            ...
            posAtaque = document.getElementById(
              "j" +
                Maquina.ultimaposicionFila +
                (Maquina.ultimaposicionColumna + 1)
            );
          } else {
            posAtaque = document.getElementById("j100");
          }
        ...
        case 3:
          if (Maquina.ultimaposicionColumna == 10) {
            posAtaque = document.getElementById(
              "j" + (Maquina.ultimaposicionFila + 2) + "0"
            );
          } else {
            posAtaque = document.getElementById(
              "j" +
                (Maquina.ultimaposicionFila + 1) +
                Maquina.ultimaposicionColumna
            );
          }
          if (posAtaque != null) {
            inicio = parseInt(posAtaque.id.substring(1, posAtaque.id.length));
        ...
        case 4:
          if (Maquina.ultimaposicionColumna == 10) {
            posAtaque = document.getElementById(
              "j" + Maquina.ultimaposicionFila + "0"
            );
          } else if (Maquina.ultimaposicionFila == 1) {
            posAtaque = document.getElementById(
              "j" + Maquina.ultimaposicionColumna
            );
          } else {
            posAtaque = document.getElementById(
              "j" +
  ...
  if (Jugador.numeroAtaque == Maquina.numeroAtaque) {
    if (PosicionBarco(fila, columna, Maquina, true) >= 0) {
      ...
      document
        .querySelector("#" + posAtaque.id + " span")
        .classList.add("circuloTocado");
    ...
    if (PosicionBarco(fila, columna, Jugador, true) >= 0) {
      ...
      if (Maquina.tamBarcoDanado == 0 && Maquina.totalDanano < 5) {
        ...
        (Maquina.tamBarcoDanado == 2 || Maquina.tamBarcoDanado == 3) &&
        Maquina.totalDanano < 3
      ) {
        Maquina.continuar = true;
        Maquina.totalDanano++;
...
function agregarBotones(nombre, clase) {
  let boton =
    "<button id='" + nombre + "' class='" + clase + "'>" + nombre + "</button>";
...
function crearCajaBotones() {
  ...
  document.getElementById("cajaInformacion").innerHTML +=
    "<div id='cajatexto'>";
...
function agregarALaEscuchaBotonesConfiguracion() {
  document
    .getElementById("IniciarJuego")
    .addEventListener("click", function () {
      document.getElementById("IniciarJuego").classList.remove("show");
      document.getElementById("IniciarJuego").classList.add("hidden");
      document.getElementById("cajaBotones").classList.add("hidden");
      mostrarPosicionAtaque();
      clickAtacar();
    });
  document
    .getElementById("PartidaNueva")
    .addEventListener("click", function () {
      anadirBarcosAleatorios(Maquina);
      document.getElementById("PartidaNueva").classList.remove("show");
      document.getElementById("PartidaNueva").classList.add("hidden");
      document.getElementById("PosicionesAutomaticas").classList.add("show");
    });
  
  document
    .getElementById("PosicionesAutomaticas")
    .addEventListener("click", function () {
      anadirBarcosAleatorios(Jugador);
      document
        .getElementById("PosicionesAutomaticas")
        .classList.remove("show");
      document.getElementById("PosicionesAutomaticas").classList.add("hidden");
      document.getElementById("IniciarJuego").classList.add("show");
    });
}
...
function mostrarPosicionAtaque() {
  ...
  for (let i = 0; i < 100; i++) {
    pos[i + 1].addEventListener("mouseleave", function () {
      document
        .querySelector("#" + pos[i + 1].id + " span")
        .classList.remove("ataque");
    });
    pos[i + 1].addEventListener("mouseenter", function () {
      document
        .querySelector("#" + pos[i + 1].id + " span")
        .classList.add("ataque");
    });
  }
}
...
function cargarJuego(texto) {
  ...
  agregarBotones("IniciarJuego", "hidden");
  agregarBotones("PartidaNueva", "show");
  agregarBotones("PosicionesAutomaticas", "hidden");
